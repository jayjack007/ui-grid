var app = angular.module('app1', ['ngAnimate', 'ngTouch', 'ui.grid']);

app.controller('MainCtrl1', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
    var today = new Date();
